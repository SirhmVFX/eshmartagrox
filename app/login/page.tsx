      ...
      <div className="w-[90%] max-w-md mx-auto bg-white rounded-3xl shadow-xl p-8">
        ...
        <form onSubmit={handle} className="space-y-5">
          ...
          <div className="flex items-center justify-between gap-4">
            <button className="w-full bg-green-900 text-white rounded-xl px-4 py-3 text-base font-semibold hover:bg-green-800 transition" type="submit" disabled={loading}>{loading ? "Signing in..." : "Sign in"}</button>
          </div>
